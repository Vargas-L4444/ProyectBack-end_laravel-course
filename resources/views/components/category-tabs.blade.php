        ...
        <li class="me-2">
            <a href="{{ route('post.byCategory', $category) }}"
                class="{{ 
                    ...
                    ? 'inline-block px-4 py-2 text-white bg-blue-600 rounded-lg active' : 'inline-block px-4 py-2 hover:text-gray-900 hover:bg-gray-100 rounded-lg dark:hover:bg-gray-800 dark:hover:text-white' 
                }}">
                {{ $category->name }}
            </a>
        </li>
